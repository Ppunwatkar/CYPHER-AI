...
export const SystemStatusModal: React.FC<SystemStatusModalProps> = ({ isOpen, onClose }) => {
  ...
  const services: ServiceHealthStatus[] = IS_DEMO_MODE ? [
    {
  ...
  ] : [
    {
      ...
      status: 'Not Configured',
      latencyMs: 0,
      notes: 'API key not configured in environment.'
    },
    {
      service: 'RAG Vector Knowledge Core (ChromaDB / Vector)',
      category: 'Storage',
      status: 'Not Configured',
      latencyMs: 0,
      notes: 'Knowledge repository is empty (0 documents).'
    },
    {
      service: 'Telemetry & Target Store (State Engine)',
      category: 'Storage',
      status: 'Operational',
      latencyMs: 12,
      notes: 'Local client state store healthy.'
    },
    {
      service: 'AbuseIPDB Reputation API',
      category: 'Threat Intel',
      status: 'Not Configured',
      latencyMs: 0,
      notes: 'Connector not configured. Add API key to activate.'
    },
    {
      service: 'Shodan Internet Scanner & Banner Recon',
      category: 'Threat Intel',
    ...
    },
    {
      ...
      status: 'Not Configured',
      latencyMs: 0,
      notes: 'Connector not configured.'
    },
    {
      service: 'HaveIBeenPwned (HIBP) Credential Exposure',
      category: 'Identity',
