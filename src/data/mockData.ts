...
export const INITIAL_TARGETS: SecurityTarget[] = [
  {
    id: 'tgt-1',
    value: '185.220.101.5',
    type: 'ipv4',
...
export const INITIAL_IOC_LIST: IOCItem[] = [
  {
    id: 'ioc-1',
    value: '185.220.101.5',
    type: 'ipv4',
...
export const TARGET_IP_DOSSIER = {
  ip: '185.220.101.5',
...
export const ACTIVE_CASES: InvestigationCase[] = [
  {
    id: 'case-8941',
    caseNumber: 'INC-8941',
...
export const INITIAL_SECURITY_REPORT: SecurityReport = {
  id: 'rep-8941',
